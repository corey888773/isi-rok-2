...
namespace Silownia.Controllers
{
    public class UzytkownikController : Controller
    {
        ...
        public UzytkownikController(MvcUzytkownikContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Uzytkownik != null ? 
                        ...
                        Problem("Entity set 'MvcUzytkownikContext.Uzytkownik'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Haslo,Imie,Nazwisko,CzyAdministrator,CzyPracownik")] Uzytkownik uzytkownik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Haslo,Imie,Nazwisko,CzyAdministrator,CzyPracownik")] Uzytkownik uzytkownik)
        {
            if (id != uzytkownik.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcUzytkownikContext.Uzytkownik'  is null.");
            }
            var uzytkownik = await _context.Uzytkownik.FindAsync(id);
            if (uzytkownik != null)
            {
